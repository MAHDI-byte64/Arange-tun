...
const sumsFile = `b6d6e94459a69ff58f9bf5219c802673459edf41e411e01d81b0bf8c42835607  arange-tun_linux_amd64.tar.gz
19bb7c77150be971a798bf6b4f63f638f24b33eb60605e70ccd6f776431cf6ea  arange-tun_linux_arm64.tar.gz
`

func TestHashForPicksTheRightAsset(t *testing.T) {
	got := hashFor(sumsFile, "arange-tun_linux_arm64.tar.gz")
...
func TestHashForUnknownAsset(t *testing.T) {
	...
	if got := hashFor(sumsFile, "arange-tun_linux_riscv.tar.gz"); got != "" {
