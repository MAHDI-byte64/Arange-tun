...
// used by the interactive arange-tun menu. No third-party dependencies.
//
...
// Logo prints the arange-tun banner and version.
func Logo(version string) {
 ...
 ╚═════╝ ╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝     ╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝`)
	...
	fmt.Println(Gray + " TeleGram : @BlackProtocols  |  GitHub : https://github.com/mahdi-byte64" + Reset)
}
