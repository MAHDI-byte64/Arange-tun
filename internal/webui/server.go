...
func Serve() error {
	...
	mux.HandleFunc("/api/tunnels/stop", srv.requireAuth(srv.handleTunnelStop))
	mux.HandleFunc("/api/tunnels/start", srv.requireAuth(srv.handleTunnelStart))
	...
	mux.HandleFunc("/api/wg/get", srv.requireAuth(srv.handleWGGet))
	...
	mux.HandleFunc("/api/spoof/client", srv.requireAuth(srv.handleSpoofClientCreate))
	mux.HandleFunc("/api/spoof/server", srv.requireAuth(srv.handleSpoofServerCreate))
	mux.HandleFunc("/api/spoof/get", srv.requireAuth(srv.handleSpoofGet))
	mux.HandleFunc("/api/spoof/list", srv.requireAuth(srv.handleSpoofList))
	mux.HandleFunc("/api/spoof/scan", srv.requireAuth(srv.handleSpoofScan))
	mux.HandleFunc("/api/spoof/test/receive", srv.requireAuth(srv.handleSpoofTestReceive))
	mux.HandleFunc("/api/spoof/test/send", srv.requireAuth(srv.handleSpoofTestSend))
