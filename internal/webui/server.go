...
func Serve() error {
	...
	mux.HandleFunc("/api/hedioum/foreign", srv.requireAuth(srv.handleHedioumForeignCreate))
	mux.HandleFunc("/api/hedioum/iran", srv.requireAuth(srv.handleHedioumIranCreate))
	mux.HandleFunc("/api/hedioum/get", srv.requireAuth(srv.handleHedioumGet))
