// Package app holds shared constants and paths used across the arange-tun
...
const (
	...
	ConfigDir = "/etc/arange-tun"

	// ServiceDir is the systemd unit directory.
	ServiceDir = "/etc/systemd/system"

	// ServicePrefix is prepended to every tunnel systemd unit.
	ServicePrefix = "arange-tun-"

	// BinPath is where the arange-tun binary is installed.
	BinPath = "/usr/local/bin/arange-tun"
	...
	AutoRefreshMarker = "arange-tun-auto-refresh"
	...
	WebUIService = "arange-tun-webui.service"
	...
	MonitorService = "arange-tun-monitor.service"
	...
	ProxyService = "arange-tun-proxy.service"
...
func SocksPortForToken(token string) int {
	...
	sum := sha256.Sum256([]byte("arange-tun-socks-v1:" + token))
