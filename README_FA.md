...
**آرنج‌تان** یک هسته‌ی تونل معکوس (Reverse Tunnel) با کارایی بالاست که کاملاً با **Go**
...
<p align="center"><img src="img/architecture.svg" alt="معماری آرنج‌تان: کاربر به پورت forward‌شده روی سرور ایران وصل می‌شود، انجین آن را از یک ترنسپورت به کلاینت خارج می‌برد و کلاینت به سرویس واقعی می‌رساند. کلاینت به سرور dial می‌کند." width="100%"></p>
...
- **هشدار** وقتی CPU، رم یا دیسک از حد بگذرد، تونلی بیفتد یا برگردد، یا **نسخه‌ی
  جدید آرنج‌تان منتشر شود** — با یک پیام «برگشت به حالت عادی» برای هرکدام.
...
اگر آرنج‌تان برات مفید بود، یه ستاره یا یه دونیت کوچیک خیلی ارزشمنده. 🙏
